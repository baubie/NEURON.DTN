...
class Sandbox(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Primary->DTN_AMPA"].delay = 6 + uniform(0, 1.0)
        ...
        self.nc["Primary->DTN_GABA"].delay = 12 + uniform(0, 1.0)
        ...
        self.nc["Primary->DTN_Glyc"].delay = 3+uniform(0, 1.0)
...
class MatchMU14_7_002(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Onset->DTN_AMPA"].delay = 0 + uniform(0, 1.0)
        ...
        self.nc["PrimaryW->DTN_GABA"].delay = 0 + uniform(0.0, 1.0)
...
class MatchUW231_4_008(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Offset->DTN_AMPA"].delay = 5+uniform(0.0,1.0) 
        ...
        self.nc["Onset->DTN_NMDA"].delay = 12+uniform(0.0,1.0)

        self.nc["Primary->DTN_Gly"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["Gly"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_Gly"].weight[0] = 0.0010 #uniform(0.0018, 0.0022) #0.001
        self.nc["Primary->DTN_Gly"].delay = 5+uniform(0.0,1.0)
...
class MatchRAT39_164(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Onset->DTN_Glyc"].delay = 30+uniform(0.0,1.0)

        self.nc["Primary->DTN_AMPA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["AMPA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_AMPA"].weight[0] = 0.006
        self.nc["Primary->DTN_AMPA"].delay = 35 + uniform(0, 5.0)

        self.nc["Primary->DTN_GABA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["GABA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_GABA"].weight[0] = 0.005
        self.nc["Primary->DTN_GABA"].delay = 170 + uniform(0, 1.0)

        self.nc["Primary->DTN_Glyc"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["Gly"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_Glyc"].weight[0] = 0.002
        self.nc["Primary->DTN_Glyc"].delay = 05+uniform(0, 1.0)
...
class MatchRAT9_39(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Primary->DTN_AMPA"].delay = 18 + uniform(0, 5.0)

        self.nc["Primary->DTN_GABA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["GABA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_GABA"].weight[0] = 0.003
        self.nc["Primary->DTN_GABA"].delay = 28 + uniform(0, 1.0)

        self.nc["Primary->DTN_Glyc"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["Gly"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_Glyc"].weight[0] = 0.005
        self.nc["Primary->DTN_Glyc"].delay = 6+uniform(0, 1.0)
######
...
class Onset_Shortpass_1ms_VerySharp(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Onset->DTN_AMPA"] = h.NetCon(self.cells['Onset'](0.5)._ref_v, self.syn["dtn"]["AMPA"], sec=self.cells['Onset'])
        self.nc["Onset->DTN_AMPA"].weight[0] = 0.0045
        self.nc["Onset->DTN_AMPA"].delay = 0 + uniform(0, 2.0)

        self.nc["PrimaryW->DTN_GABA"] = h.NetCon(self.cells['PrimaryW'](0.5)._ref_v, self.syn["dtn"]["GABA"], sec=self.cells['PrimaryW'])
        self.nc["PrimaryW->DTN_GABA"].weight[0] = 0.003
        self.nc["PrimaryW->DTN_GABA"].delay = 0 + uniform(0.0, 2.0)
...
class Sustained_Bandpass_5ms_Sharp(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Primary->DTN_AMPA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["AMPA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_AMPA"].weight[0] = 0.008
        self.nc["Primary->DTN_AMPA"].delay = 5 + uniform(0, 1.0)

        self.nc["Primary->DTN_GABA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["GABA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_GABA"].weight[0] = 0.005
        self.nc["Primary->DTN_GABA"].delay = 10 + uniform(0, 1.0)

        self.nc["Primary->DTN_Glyc"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["Gly"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_Glyc"].weight[0] = 0.005
        self.nc["Primary->DTN_Glyc"].delay = uniform(0, 1.0)
...
class Onset_Shortpass_1ms_Sharp_Jitter(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Onset->DTN_Gly"].delay = uniform(0,1.0)

        self.nc["Onset->DTN_AMPA"] = h.NetCon(self.cells['Onset'](0.5)._ref_v, self.syn["dtn"]["AMPA"], sec=self.cells['Onset'])
        self.nc["Onset->DTN_AMPA"].weight[0] = 0.005
        self.nc["Onset->DTN_AMPA"].delay = 5 + uniform(0, 1.0)

        self.nc["Primary->DTN_GABA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["GABA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_GABA"].weight[0] = 0.0005
        self.nc["Primary->DTN_GABA"].delay = uniform(0, 1.0)
...
class Offset_Bandpass_11ms_Wide(BaseNetwork):
    def __init__(self):
        ...
        self.nc["Primary->DTN_GABA"] = h.NetCon(self.cells['Primary'](0.5)._ref_v, self.syn["dtn"]["GABA"], sec=self.cells['Primary'])
        self.nc["Primary->DTN_GABA"].weight[0] = 0.0001 #uniform(0.0018, 0.0022) #0.001
